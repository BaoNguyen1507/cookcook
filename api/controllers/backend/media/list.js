...
module.exports = {
  ...
  fn: async function (inputs, exits) {
    ...
    let totalAll = await MediaService.count({});
    let totalActive = await MediaService.count({type:type,status: _default.STATUS.ACTIVE});
    let totalDraft = await MediaService.count({type:type,status: _default.STATUS.DRAFT}); 
