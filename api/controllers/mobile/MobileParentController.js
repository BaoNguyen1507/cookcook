...
module.exports = {
  ...
  edit: async (req, res) => {
    ...
    if (!params.firstName && !params.firstName.trim().length) {
      ...
      return res.badRequest(ErrorMessage.PARENT_ERR_PHONE_REQUIRED);
    }
    ...
    if (foundEmailUser.length) {
      ...
      return res.badRequest(ErrorMessage.PARENT_ERR_PHONE_PARENT_EXISTED);
    }
