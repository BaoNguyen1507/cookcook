class IndexFormPostBackendEKP extends BaseBackendEKP {
  constructor() {
    super();
    this.initialize();
  }
  ...
  initialize() {
    ...
    this.form = new FormIndexPostBackendEKP(this);
  }
}

class FormIndexPostBackendEKP {
  constructor(opts) {
    _.extend(this, opts);
    this.formId = 'formPost';
