...
Cloud.setup({
  ...
  methods: {
    ...
    "registerSA": {
      "verb": "PATCH",
      "url": "/api/v1/installation/registerSA"
    },
    "addSetting": {
      "verb": "POST",
    ...
    //ATTENDENT
    // "checkExistedAttendent": {
    //   "verb": "GET",
    //   "url": "/api/v1/backend/class-:classId/attendent",
    //   "args": ["classId", "date"]
    // },
    "getAttendent": {
      "verb": "GET",
    ...
    "addTuition": {
      "verb": "POST",
      "url": "/api/v1/backend/tuition/add",
      "args": ["title", "status", "ofClass"]
    },
    "getTuition": {
      "verb": "GET",
      "url": "/api/v1/backend/tuition/:id",
      "args": ["id"]
    },
    "editTuition": {
      "verb": "POST",
    ...
    "trashTuition": {
      "verb": "POST",
      "url": "/api/v1/backend/tuition/trash/:ids",
      "args": ["ids"]
    },
    "searchTuition": {
      "verb": "GET",
      "url": "/api/v1/backend/tuition/search",
      "args": ["title", "status", "ofClass"]
    },
    "switchStatusTuition": {
      "verb": "PATCH",
      "url": "/api/v1/backend/tuition/switchStatus/:id"
    },
    //-----------------Tuition check-------------------
    "getTuitionCheck": {
      "verb": "GET",
      "url": "/api/v1/backend/tuitionCheck/get/:id",
      "args": ["id"]
    },
    "editTuitionCheck": {
      "verb": "PATCH",
      "url": "/api/v1/backend/tuitionCheck/edit/:id",
      "args": ["id"]
    },
    "searchTuitionCheck": {
      "verb": "GET",
      "url": "/api/v1/backend/tuitionCheck/search",
      "args": ["status"]
    },
    //
    "confirmEmail": {
    ...
    "addUser": {
      ...
      "args": ["emailAddress", "phone", "firstName", "lastName", "password", "birthday", "status", "type"]
    },
    "getUser": {
      "verb": "GET",
